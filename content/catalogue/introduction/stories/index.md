...
Kleiderbügel erzählen viele Geschichten, von persönlichen Erinnerungen, wie z.B. durch die Bügel, die man im Hotel (z.B. {{< print-ref slug="103" >}}) oder beim Wehrdienst (z.B. {{< print-ref slug="120" >}}) hat mitgehen lassen, über regionale Entwicklungen bis hin zu den größeren Zusammenhängen der Weltgeschichte.
...
* Fahning, {{< print-ref slug="48" >}} und {{< print-ref slug="218" >}}: Die Damenbekleidungsfirma [Gebr. Hirschfeld](https://de.wikipedia.org/wiki/Gebr._Hirschfeld "Wikipedia: Gebr. Hirschfeld") wurde nach der Reichspogromnacht an Franz Fahning verkauft. Einer der Brüder, Benno Hirschfeld, wurde im KZ Buchenwald ermordet.
{.single}
<!-- * {{< print-ref slug="195" title=true >}}: 1888 als [Hamburger & Littauer](https://de.wikipedia.org/wiki/Hamburger_%26_Littauer "Wikipedia: Hamburger & Littauer") gegründet, 1933 "arisiert". -->
...
Auch die territorialen Neuordnungen nach dem Zweiten Weltkrieg werden sichtbar. Besonders deutlich wird dies bei der Polnischen Westverschiebung, die auf der [Potsdamer Konferenz von 1945](https://www.bpb.de/kurz-knapp/hintergrund-aktuell/312929/die-potsdamer-konferenz/ "bpb: Die Potsdamer Konferenz") beschlossen wurde. Von dieser Verschiebung waren vor allem die Gebiete östlich der neu festgelegten Oder-Neiße-Linie sowie Danzig, Stettin und Ostpreußen betroffen. Beispiele aus dem heutigen Polen sind:

* Szczecin (Stettin, ehemalige Provinz Pommern): {{< print-ref slug="183" title=true >}}
* Trzcianka (Schönlanke, ehemalige Provinz Posen): {{< print-ref slug="92" title=true >}}
* Kamienna Góra (Landeshut, ehemalige Provinz Schlesien): {{< print-ref slug="24" title=true >}}
{.single}
